  ...
  return (
    <div className="main-page">
      <div className="main-text">
        ...
        <h5>
          I am a seasoned front-end developer with over 6 years of extensive
          experience, specializing in designing and developing flawless websites
          and web applications. If you're looking for a skilled professional to
          collaborate with, I would be thrilled to work with you.
        </h5>
      </div>
      <div className="main-image-main">
        <img
          src="https://lh3.googleusercontent.com/JJIKyNdYizMKxS7X0bwtFNaalOXFHQrphU8FesXiltTt7C5LH4238Ptz6yIXZxhUTayuUWaNXib8pSra2Iyofdv6OMRoKZa1efBxLyUdV5qEriW8IctsDAQ7sQESoSM6ppbYQcGjNw=w2400"
          alt="Eshan image"
        />
      </div>
