...
const Portfolio = () => {
  ...
  return (
    <div
      ref={ref}
      className={`portfolio-gallery fade-in-section ${
    ...
    >
      <div className="container">
        <div className="section-header">
          ...
          <h2>Featured Work</h2>
          <p>
            Client projects and web applications I've designed and developed
          </p>
        </div>
        ...
        <div className="projects-wrapper">
          <div className="project">
            <a href="https://www.serendib.io/" target="_blank">
              ...
              <h5>
                Adobe Photoshop, Adobe Illustrator, HTML5, CSS, JavaScript
              </h5>
              <p>
                Elevated the digital footprint for Serendib Systems, a dynamic
                software development company with a presence in Australia and
                Sri Lanka. Crafted, and developed their website to precisely
          ...
          <div className="project">
            <a href="https://eshanrajapakshe.github.io/biogen/" target="_blank">
              ...
              <p>
                Designed, developed, and hosted the website for Biogen, an
                Organic Agriculture Solution Company, aligning seamlessly with
          ...
          <div className="project">
            <a href="https://spice-chest.netlify.app/" target="_blank">
              ...
              <p>
                Transformed the online presence for Spice Chest, a leading
                Spices and Herbs exporting company, by designing, developing,
                and hosting their website to align seamlessly with their unique
                requirements.
              </p>
            </a>
          </div>
          ...
          <div className="project">
            <a href="https://integrityalert.ai/" target="_blank">
              ...
              <p>
                IntegrityAlert.ai, tailored for global enterprises, fosters
                active corporate integrity engagement by seamlessly integrating
